...
public class EmpSearchF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("(E.g. dd/mm/year)");
      ...
      public void Search(){
        ...
        try{
            ...
            while (rs.next()) {
               ...
               /* jRadioButton1.setText(rs.getString("gender"));
                jRadioButton2.setText(rs.getString("gender"));  */
                ...
                jTextField9.setText(rs.getString("pincode"));
                jTextField10.setText(rs.getString("contactno"));
                jTextField11.setText(rs.getString("designation"));
                jTextField12.setText(rs.getString("department"));
                jTextField13.setText(rs.getString("doj"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpSearchF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpSearchF().setVisible(true);
            }
        });
    }
