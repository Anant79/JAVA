...
public class WelcomeF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/payrollms2/Login.jpg"))); // NOI18N
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        try
            ...
            if ((Name.equals(rs.getString("username"))) && (Password.equals(rs.getString("password"))))
                {
                    javax.swing.JOptionPane.showMessageDialog(null, "USERNAME AND PASSWORD IS VALID");
            ...
            else if((Name.equals(rs.getString("username")))||(Password.equals("")))
                {
                    javax.swing.JOptionPane.showMessageDialog(null, "INVALID USER NAME OR PASSWORD");
                }
            else if((Name.equals(""))||(Password.equals(rs.getString("password"))))
                {
                    javax.swing.JOptionPane.showMessageDialog(null, "INVALID USER NAME OR PASSWORD");
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WelcomeF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
