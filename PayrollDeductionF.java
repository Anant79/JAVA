...
public class PayrollDeductionF extends javax.swing.JFrame {
     Connection con = null;
     Statement st;
     ResultSet rs;
     
    public PayrollDeductionF() {
        initComponents();
        this.con=null;
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Deduction Info"));

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel8.setText("Advance Pay");
        ...
        jLabel14.setText("Provisional Fund");
        ...
        jLabel9.setText("(E.g. dd/mm/year)");
    ...
    public void Search(){
        String EMP_ID=null;
        EMP_ID=jTextField5.getText().trim();
        try{
    ...
    public void AddDeduction(){
        ...
        String ADVANCE_PAY = jTextField7.getText().trim();
        String PROFESSIONAL_TAX=jTextField9.getText().trim();
        String LOAN=jTextField11.getText().trim();
        String PROVISIONAL_FUND=jTextField13.getText().trim();
        try
        {            
                 con=DatabaseHelper.getConnection();
                 
                 PreparedStatement ps=con.prepareStatement("insert into deductioninfo values(?,?,?,?,?)");
                 
                 ps.setString(1,EMP_ID);
                 ps.setString(2,ADVANCE_PAY);
                 ps.setString(3,PROFESSIONAL_TAX);
                 ps.setString(4,LOAN);
                 ps.setString(5,PROVISIONAL_FUND);
                 ps.execute(); 
                 javax.swing.JOptionPane.showMessageDialog(null, "DEDUCTION IS UPDATED SUCCESSFULLY!!!");
                 con.close();
                 reset();
        }
        catch(Exception e)
    ...
    public void reset()
   {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayrollDeductionF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PayrollDeductionF().setVisible(true);
            }
        });
    }
