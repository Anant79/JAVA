...
public class RIncentiveF extends javax.swing.JFrame {
    Connection con;
    ResultSet rs;
    Statement st;
    String data[][] = {};
    String col[] = {"EmpID", "Name", "Designation", "Department","HRA Amount","DA Amount","CCA Amount","TA Amount","Medical Amount"};
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Incentive Report");
    ...
    public void AllEmployee(){
        ...
        try{
                ...
                rs = st.executeQuery("SELECT newemployee.empid,name,designation,department,hraamount,daamount,ccaamount,taamount,medicalamount from  newemployee,incentiveinfo where newemployee.empid=incentiveinfo.empid");
                while (rs.next()) 
                {              
                    model.insertRow(jTable1.getRowCount(), new Object[]{rs.getString(1), rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9)});
                }
            }
            catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RIncentiveF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RIncentiveF().setVisible(true);
            }
        });
    }
