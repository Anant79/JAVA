...
public class PayrollBonusF extends javax.swing.JFrame {

    Connection con = null;
     Statement st;
     ResultSet rs;
     
    public PayrollBonusF() {
        initComponents();
        this.con=null;
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Bonus Info"));

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel8.setText("Bonus Type");

        jComboBox1.setBackground(new java.awt.Color(166, 255, 255));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Any", "Diwali", "Christmas", "New Year ", "Marriage", " " }));

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel9.setText("Bonus Amount");
        ...
        jLabel11.setText("(E.g.dd/mm/year)");
    ...
    public void Search(){
        String EMP_ID=null;
        EMP_ID=jTextField7.getText().trim();
        try{
    ...
    public void AddBonusInfo(){
        enable();
        String EMP_ID=jTextField1.getText().trim();
        String BONUS_TYPE = jComboBox1.getSelectedItem().toString();
        String BONUS_AMOUNT=jTextField5.getText().trim();
        
        try
        {            
                 con=DatabaseHelper.getConnection();
                 
                 PreparedStatement ps=con.prepareStatement("insert into bonusinfo values(?,?,?)");
                 
                 ps.setString(1,EMP_ID);
                 ps.setString(2,BONUS_TYPE);
                 ps.setString(3,BONUS_AMOUNT);
                 ps.execute(); 
                 javax.swing.JOptionPane.showMessageDialog(null, "BONUS IS UPDATED SUCCESSFULLY!!!");
                 con.close();
                 reset();
        }
        catch(Exception e)
    ...
    public void reset()
   {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayrollBonusF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PayrollBonusF().setVisible(true);
            }
        });
    }
