...
public class RBasicF extends javax.swing.JFrame {
    Connection con;
    ResultSet rs;
    Statement st;
    String data[][] = {};
    String col[] = {"EmpID", "Name", "Designation", "Department","Salary Type", "Salary Amount"};
    ...
    public void AllEmployee(){
        ...
        try{
                ...
                rs = st.executeQuery("SELECT newemployee.empid,name,designation,department,salarytype,salaryamount from newemployee,basicsalary where newemployee.empid=basicsalary.empid");
                while (rs.next()) 
                {              
                    model.insertRow(jTable1.getRowCount(), new Object[]{rs.getString(1), rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6)});
                }
            }
            catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RBasicF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
