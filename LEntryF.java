...
public class LEntryF extends javax.swing.JFrame {
        Connection con = null;
        Statement st;
        ResultSet rs;
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Provide Leave"));

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel8.setText("Total Leave");

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel9.setText("Leave From");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Any", "Absent", "Sickness", "Casual", "Break" }));
        ...
        jLabel13.setText("(E.g.dd/mm/year)");
    ...
    public void Search(){
        String EMP_ID=null;
        EMP_ID=jTextField10.getText().trim();
        try{
    ...
    public void AddLeaveEntry(){
        ...
        String LEAVE_TYPE = jComboBox1.getSelectedItem().toString();
        String TOTAL_LEAVE=jTextField7.getText().trim();
        String LEAVE_FROM=jTextField5.getText().trim();
        String LEAVE_TO=jTextField8.getText().trim();
        
        try
        {            
                 con=DatabaseHelper.getConnection();
                 
                 PreparedStatement ps=con.prepareStatement("insert into leaveentry values(?,?,?,?,?)");
                 
                 ps.setString(1,EMP_ID);
                 ps.setString(2,LEAVE_TYPE);
                 ps.setString(3,TOTAL_LEAVE);
                 ps.setString(4,LEAVE_FROM);
                 ps.setString(5,LEAVE_TO);
                 
                 ps.execute(); 
                 javax.swing.JOptionPane.showMessageDialog(null, "LEAVE IS UPDATED SUCCESSFULLY!!!");
                 con.close();
        }
        catch(Exception e)
        { 
    ...
    public void SearchLeaveType(){
        ...
        LEAVE_TYPE=jComboBox1.getSelectedItem().toString();
        
        try{
            con=DatabaseHelper.getConnection();
            st = con.createStatement();
            rs = st.executeQuery("SELECT * FROM leaveentry WHERE leavetype='"+LEAVE_TYPE+"'");
            while(rs.next()){
                jTextField7.setText(rs.getString("totalleave"));
                jTextField5.setText(rs.getString("leavefrom"));
                jTextField8.setText(rs.getString("leaveto"));
    ...
    public void AddTotalLeave(){
        enable();
        String LEAVE_TYPE=null;
        LEAVE_TYPE=jComboBox1.getSelectedItem().toString();
        
        if(LEAVE_TYPE =="Select Any")
            javax.swing.JOptionPane.showMessageDialog(null, "Select An Appropriate Leave.");
        else if(LEAVE_TYPE == "Absent")
            AddAbsent();
        else if(LEAVE_TYPE == "Sickness")
            AddSickness();
    ...
    public void AddAbsent(){
        enable();
        String EMP_ID=jTextField1.getText().trim();
        String TOTAL_ABSENT = jTextField7.getText().trim();
        ...
        {            
                 ...
                 PreparedStatement ps=con.prepareStatement("INSERT INTO leaveentryabsent VALUES(?,?)");
                
                 
                 ps.setString(1,EMP_ID);
                 ps.setString(2,TOTAL_ABSENT);
                 
                 ps.execute(); 
                 javax.swing.JOptionPane.showMessageDialog(null, "ABSENT IS UPDATED SUCCESSFULLY!!!");
                 con.close();
                 reset();
        }
        catch(Exception e)
    ...
    public void AddSickness(){
        enable();
        String EMP_ID=jTextField1.getText().trim();
        String TOTAL_SICKNESS = jTextField7.getText().trim();
        try
        {            
                 con=DatabaseHelper.getConnection();
                 
                 PreparedStatement ps=con.prepareStatement("INSERT into leaveentrysickness VALUES(?,?)");
                 
                 ps.setString(1,EMP_ID);
                 ps.setString(2,TOTAL_SICKNESS);
                 ps.execute(); 
                 javax.swing.JOptionPane.showMessageDialog(null, "SICKNESS IS UPDATED SUCCESSFULLY!!!");
                 con.close();
                 reset();
        }
        catch(Exception e)
    ...
    public void AddCasual(){
        enable();
        String EMP_ID=jTextField1.getText().trim();
        String TOTAL_CASUAL = jTextField7.getText().trim();
        try
        {            
                 con=DatabaseHelper.getConnection();
                 
                 PreparedStatement ps=con.prepareStatement("INSERT INTO leaveentrycasual VALUES(?,?)");
                 
                 ps.setString(1,EMP_ID);
                 ps.setString(2,TOTAL_CASUAL);
                 ps.execute();
                 javax.swing.JOptionPane.showMessageDialog(null, "CASUAL IS UPDATED SUCCESSFULLY!!!");
                 con.close();
                 reset();
        }
        catch(Exception e)
    ...
    public void AddBreak(){
        enable();
        String EMP_ID=jTextField1.getText().trim();
        String TOTAL_Break = jTextField7.getText().trim();
        try
        {            
                 con=DatabaseHelper.getConnection();
                 
                 PreparedStatement ps=con.prepareStatement("INSERT INTO leaveentrybreak VALUES(?,?)");
                 
                 ps.setString(1,EMP_ID);
                 ps.setString(2,TOTAL_Break);
                 ps.execute(); 
                 javax.swing.JOptionPane.showMessageDialog(null, "BREAK IS UPDATED SUCCESSFULLY!!!");
                 con.close();
                 reset();
        }
        catch(Exception e)
     ...
     public void reset()
   {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LEntryF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
