...
public class EmpUpdateF extends javax.swing.JFrame {
    ...
    public void Search(){
        String EMP_ID=null;
        EMP_ID=jTextField13.getText().trim();
        String Male = null;
        ...
        try{
            ...
            while (rs.next()) {
                ...
                jTextField7.setText(rs.getString("state"));
                jTextField8.setText(rs.getString("pincode"));
                jTextField9.setText(rs.getString("contactno"));
                jTextField10.setText(rs.getString("designation"));
                jTextField11.setText(rs.getString("department"));
                jTextField12.setText(rs.getString("doj"));
    ...
    public void UpdateEmployee(){
        ...
        String FATHER_NAME=jTextField3.getText().trim();
        ...
        String PINCODE=jTextField8.getText().trim();
        String CONTACT_NUM=jTextField9.getText().trim();
        String DESIGNATION=jTextField10.getText().trim();
        String DEPARTMENT=jTextField11.getText().trim();
        String DATE_OF_JOINING=jTextField12.getText().trim();
        String REMARKS=jTextArea1.getText().trim();
       
        String SQL="update newemployee set name=?,fathername=?,gender=?,dob=?,address=?,city=?,state=?,pincode=?,contactno=?,designation=?,department=?,doj=?,remarks=? where empid=?";
        try{            
                 DatabaseHelper dh=new DatabaseHelper();
                 con=dh.getConnection();
                 ...
                 ps.setString(9,CONTACT_NUM);
                 ps.setString(10,DESIGNATION);
                 ps.setString(11,DEPARTMENT);
                 ps.setString(12,DATE_OF_JOINING);
                 ps.setString(13,REMARKS);  
                 ps.setString(14,EMP_ID); 
    ...
    public void reset()
   {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setBackground(new java.awt.Color(166, 240, 240));
        ...
        jRadioButton2.setBackground(new java.awt.Color(166, 240, 240));
        ...
        jLabel4.setText("(E.g. dd/mm/year)");

        jLabel18.setText("(E.g. dd/mm/year)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpUpdateF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpUpdateF().setVisible(true);
            }
        });
    }
