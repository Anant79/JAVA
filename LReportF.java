...
public class LReportF extends javax.swing.JFrame {
    Connection con;
    ResultSet rs,rs1;
    Statement st;
    String data[][] = {};
    String col[] = {"EmpID", "Name", "Designation", "Department", "Total Absent", "Total Sickness", "Total Casual", "Total Break"};
    ...
    public void AllEmployee(){
        ...
        try{
                ...
                //rs = st.executeQuery("SELECT * FROM newemployee ");
                //SELECT newemployee.empid,name,designation,department,advancepay,professionaltax,loan,provisionalfund FROM newemployee,deductioninfo WHERE newemployee.empid=deductioninfo.empid");
               
                rs = st.executeQuery("SELECT  newemployee.empid,name,designation,department,totalabsent FROM newemployee ,leaveentryabsent WHERE newemployee.empid=leaveentryabsent.empid");
                //rs1 = st.executeQuery("SELECT  newemployee.empid,name,designation,department,totalsickness FROM newemployee ,leaveentrysickness WHERE newemployee.empid=leaveentrysickness.empid");
               // rs1 = st.executeQuery("EMP")

                while (rs.next()) 
                {              
                    model.insertRow(jTable2.getRowCount(), new Object[]{rs.getString(1), rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5)});
                }
                
                
                
               //rs=st.executeQuery("select * from leaveentryabsent")

               // while (rs.next()) 
               //// {              
                    //model.addColumn(jTable2.getRowCount(), new Object[]{rs.getString(2)});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LReportF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
