...
public class RAEmpF extends javax.swing.JFrame {
    Connection con;
    ResultSet rs;
    Statement st;
    String data[][] = {};
    String col[] = {"EmpID", "Name", "Department", "Date of Joining", "Remarks"};
    ...
    public void AllEmployee(){
        ...
        try{
                ...
                while (rs.next()) 
                {              
                    model.insertRow(jTable1.getRowCount(), new Object[]{rs.getString(1), rs.getString(2),rs.getString(12),rs.getString(13),rs.getString(14)});
                }
            }
            catch(Exception e){
    ...
    public void SearchEmployee(){
        String EMP_ID=null;
        EMP_ID=jTextField1.getText().trim();
        if (jTable1.getRowCount() > 0) 
        {
                while (model.getRowCount() > 0) 
                {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RAEmpF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
