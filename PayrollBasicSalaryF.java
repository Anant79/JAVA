...
public class PayrollBasicSalaryF extends javax.swing.JFrame {
    Connection con = null;
     Statement st;
     ResultSet rs;
     
    
    public PayrollBasicSalaryF() {
        initComponents();
        this.con=null;
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Salary Type");

        jComboBox1.setBackground(new java.awt.Color(166, 255, 255));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Any", "Monthly", "Daily", "Annualy" }));
    ...
    public void AddSalaryInfo(){
        ...
        String SALARY_TYPE = jComboBox1.getSelectedItem().toString();
        String SALARY_AMOUNT=jTextField5.getText().trim();
        try
        {            
                 con=DatabaseHelper.getConnection();
                 
                 PreparedStatement ps=con.prepareStatement("insert into basicsalary values(?,?,?)");
                 
                 ps.setString(1,EMP_ID);
                 ps.setString(2,SALARY_TYPE);
                 ps.setString(3,SALARY_AMOUNT);
                 ps.execute(); 
                 javax.swing.JOptionPane.showMessageDialog(null, "SALARY IS UPDATED SUCCESSFULLY!!!");
                 con.close();
                 reset();
        }
        catch(Exception e)
     ...
     public void reset()
   {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayrollBasicSalaryF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PayrollBasicSalaryF().setVisible(true);
            }
        });
    }
