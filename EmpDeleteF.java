...
public class EmpDeleteF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("(E.g. dd/mm/year)");
     ...
     public void Search(){
        String EMP_ID=null;
        EMP_ID=jTextField2.getText().trim();
        String Male = null;
        String Female=null;
        ...
        try{
            ...
            while (rs.next()) {
                ...
                jTextField5.setText(rs.getString("fathername"));
                ...
                jTextField9.setText(rs.getString("state"));
                jTextField10.setText(rs.getString("pincode"));
                jTextField11.setText(rs.getString("contactno"));
                jTextField12.setText(rs.getString("designation"));
                jTextField13.setText(rs.getString("department"));
                jTextField14.setText(rs.getString("doj"));
     ...
     public void DeleteEmployee(){
         ...
         try{            
                ...
                String SQL="delete from newemployee where empid=?";
     ...
     public void reset()
   {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpDeleteF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpDeleteF().setVisible(true);
            }
        });
    }
